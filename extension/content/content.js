...
function injectUI() {
  ...
  // 3. Add your custom CSS inside the Shadow DOM (UNTOUCHED)
  ...
  // 4. Create your actual UI layout (UNTOUCHED)
  ...
  // 5. Connect UI Interactivity inside Shadow DOM
  const toggleFilter = uiScreen.querySelector('#toggle-filter');
  const statusText = uiScreen.querySelector('#status-text');
  ...
  // 6. Assemble and inject it into the website
  shadowRoot.appendChild(style);
  shadowRoot.appendChild(uiScreen);
  document.body.appendChild(container);
}

// Global click listener to hide the box when clicking outside
